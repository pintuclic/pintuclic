...
```text
<tipo>(<módulo/alcance>): [X.Y.Z] <descripción clara en minúsculas y modo imperativo>
...
graph TD
    ...
    C --> D[3. Registrar marca X.Y.Z y generar Walkthrough]
...
3. **Documentación Sincronizada:** El `CHANGELOG.md` lo actualiza el bot de versionado; confirmar que el Walkthrough refleja exactamente los cambios realizados.
