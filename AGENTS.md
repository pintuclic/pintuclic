...
1. **Determinar el Nivel SemVer:** Determinar si corresponde a `PATCH` (`[0.0.1]`), `MINOR` (`[0.1.0]`) o `MAJOR` (`[1.0.0]`) según [docs/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_VERSIONADO_Y_WALKTHROUGHS.md](./docs/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_VERSIONADO_Y_WALKTHROUGHS.md). La marca es un **nivel relativo**, nunca la versión absoluta del proyecto.
