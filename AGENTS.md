...
> 6. **Versionado Obligatorio y Walkthrough en CADA Implementación:** Tras CUALQUIER cambio o implementación de código, es MANDATORIO incrementar la versión semántica ([equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_VERSIONADO_Y_WALKTHROUGHS.md](./equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_VERSIONADO_Y_WALKTHROUGHS.md)), actualizar `equipo-2-doc/CHANGELOG.md` y generar el Walkthrough de Implementación correspondiente.
> 7. **Convención de Commits y Push Controlado:** Los commits deben crearse usando el estándar Conventional Commits con tag de versión obligatorio si aplica (`tipo(modulo): [vX.X.X] descripcion`), verificando que TypeScript compile limpio y haciendo push únicamente a la rama asignada ([equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_GIT_COMMITS_Y_PUSH.md](./equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_GIT_COMMITS_Y_PUSH.md)).
...
```mermaid
graph TD
    A[Requerimiento / HU Solicitada] --> B[1. Consultar equipo-2-doc/00_SISTEMA/01_ARQUITECTURA/MATRIZ_TRAZABILIDAD.md]
    B --> C[2. Leer Especificación en equipo-2-doc/02_MODULOS_FUNCIONALES]
    C --> D[3. Inspección OBLIGATORIA de Diagramas en equipo-2-doc/assets/diagrams/]
    D --> E[4. Leer Políticas Transversales en equipo-2-doc/01_TRANSVERSALES]
    ...
    J --> K[8. Checklist de Políticas Globales equipo-2-doc/00_SISTEMA/03_PLANTILLAS_Y_CHECKLISTS/CHECKLIST_CIERRE_MODULOS.md]
    K --> L[9. Registrar Versión en equipo-2-doc/CHANGELOG.md y Generar Walkthrough Oficial]
...
- Abre [equipo-2-doc/00_SISTEMA/01_ARQUITECTURA/MATRIZ_TRAZABILIDAD.md](./equipo-2-doc/00_SISTEMA/01_ARQUITECTURA/MATRIZ_TRAZABILIDAD.md) para determinar qué módulos transversales (`M20 Seguridad`, `M17 Permisos`, `M18 Notificaciones`) y qué **diagramas** aplican a esa historia.

### Paso 2: Lectura de la Especificación Funcional
- Abre el archivo correspondiente en `equipo-2-doc/02_MODULOS_FUNCIONALES/` (por ejemplo, [equipo-2-doc/02_MODULOS_FUNCIONALES/M04_CUENTAS_AUTH_PERFIL.md](./equipo-2-doc/02_MODULOS_FUNCIONALES/M04_CUENTAS_AUTH_PERFIL.md)).
...
Antes de escribir una sola línea de código, **debes abrir y analizar visualmente el diagrama asociado** en `equipo-2-doc/assets/diagrams/M[XX]/`:
...
- **M20 - Seguridad y Auditoría ([equipo-2-doc/01_TRANSVERSALES/M20_SEGURIDAD_Y_AUDITORIA.md](./equipo-2-doc/01_TRANSVERSALES/M20_SEGURIDAD_Y_AUDITORIA.md)):**
...
- **M17 - Permisos y Administración ([equipo-2-doc/01_TRANSVERSALES/M17_PERMISOS_Y_ROLES.md](./equipo-2-doc/01_TRANSVERSALES/M17_PERMISOS_Y_ROLES.md)):**
...
Antes de declarar el módulo finalizado, **DEBES comprobar el cumplimiento de las 3 políticas de integridad** definidas en [equipo-2-doc/00_SISTEMA/03_PLANTILLAS_Y_CHECKLISTS/CHECKLIST_CIERRE_MODULOS.md](./equipo-2-doc/00_SISTEMA/03_PLANTILLAS_Y_CHECKLISTS/CHECKLIST_CIERRE_MODULOS.md):
1. **Unicidad de Cuentas (`HU-CUE-08`):** [equipo-2-doc/01_TRANSVERSALES/POLITICAS/politica_HU-CUE-08_unicidad_cuentas.md](./equipo-2-doc/01_TRANSVERSALES/POLITICAS/politica_HU-CUE-08_unicidad_cuentas.md).
2. **Control de Acceso en Servidor (`HU-ADM-03`):** [equipo-2-doc/01_TRANSVERSALES/POLITICAS/politica_HU-ADM-03_control_acceso_servidor.md](./equipo-2-doc/01_TRANSVERSALES/POLITICAS/politica_HU-ADM-03_control_acceso_servidor.md).
3. **No Exposición de Datos Sensibles (`HU-SEG-06`):** [equipo-2-doc/01_TRANSVERSALES/POLITICAS/politica_HU-SEG-06_no_exposicion_datos_sensibles.md](./equipo-2-doc/01_TRANSVERSALES/POLITICAS/politica_HU-SEG-06_no_exposicion_datos_sensibles.md).

### Paso 9: Generación Obligatoria de Walkthrough y Actualización de Versión
Al completar la implementación, **DEBES SI O SI**:
1. **Calcular el Incremento SemVer:** Determinar si corresponde a `PATCH` (fix), `MINOR` (nueva HU/endpoint) o `MAJOR` (cierre de módulo/cambio estructural) según [equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_VERSIONADO_Y_WALKTHROUGHS.md](./equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_VERSIONADO_Y_WALKTHROUGHS.md).
2. **Actualizar `equipo-2-doc/CHANGELOG.md`:** Registrar la entrada de la nueva versión con fecha, módulo, HUs cubiertas y resumen de cambios.
3. **Generar el Walkthrough de Implementación:** Crear el documento formal usando la estructura de [equipo-2-doc/00_SISTEMA/03_PLANTILLAS_Y_CHECKLISTS/PLANTILLA_WALKTHROUGH_IMPLEMENTACION.md](./equipo-2-doc/00_SISTEMA/03_PLANTILLAS_Y_CHECKLISTS/PLANTILLA_WALKTHROUGH_IMPLEMENTACION.md), detallando:
...
Siguiendo la [Guía de Commits y Push](./equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_GIT_COMMITS_Y_PUSH.md):
...
2. **Formato del Commit:** Crear commits atómicos utilizando el estándar Conventional Commits con tag de versión coincidente con `equipo-2-doc/CHANGELOG.md` (ej: `feat(M04): [v1.1.0] implementar registro con verificacion HU-CUE-01` o `fix(M04): [v1.1.1] corregir expiracion de tokens`).
...
- [equipo-2-doc/CHANGELOG.md](./equipo-2-doc/CHANGELOG.md): Registro central de versiones del proyecto.
- [equipo-2-doc/00_SISTEMA/01_ARQUITECTURA/ARQUITECTURA_GENERAL.md](./equipo-2-doc/00_SISTEMA/01_ARQUITECTURA/ARQUITECTURA_GENERAL.md): Resumen de dominios, actores, módulos y dependencias globales.
- [equipo-2-doc/00_SISTEMA/01_ARQUITECTURA/ARQUITECTURA_BACKEND.md](./equipo-2-doc/00_SISTEMA/01_ARQUITECTURA/ARQUITECTURA_BACKEND.md): Stack oficial, directivas de aislamiento y protocolo de parada.
- [equipo-2-doc/00_SISTEMA/01_ARQUITECTURA/MATRIZ_TRAZABILIDAD.md](./equipo-2-doc/00_SISTEMA/01_ARQUITECTURA/MATRIZ_TRAZABILIDAD.md): Mapeo directo entre Historias de Usuario, Transversales y Diagramas.
- [equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_GIT_COMMITS_Y_PUSH.md](./equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_GIT_COMMITS_Y_PUSH.md): Convención de Conventional Commits y protocolo de push.
- [equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_VERSIONADO_Y_WALKTHROUGHS.md](./equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/GUIA_VERSIONADO_Y_WALKTHROUGHS.md): Estándar de SemVer y protocolo de walkthroughs.
- [equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/ESTANDAR_Y_GUIA_INCORPORACION.md](./equipo-2-doc/00_SISTEMA/02_GUIAS_Y_ESTANDARES/ESTANDAR_Y_GUIA_INCORPORACION.md): Normativa para incorporar o refactorizar módulos futuros.
- [equipo-2-doc/00_SISTEMA/03_PLANTILLAS_Y_CHECKLISTS/CHECKLIST_CIERRE_MODULOS.md](./equipo-2-doc/00_SISTEMA/03_PLANTILLAS_Y_CHECKLISTS/CHECKLIST_CIERRE_MODULOS.md): Validación obligatoria de políticas globales antes de cerrar un módulo.
- [equipo-2-doc/00_SISTEMA/03_PLANTILLAS_Y_CHECKLISTS/PLANTILLA_WALKTHROUGH_IMPLEMENTACION.md](./equipo-2-doc/00_SISTEMA/03_PLANTILLAS_Y_CHECKLISTS/PLANTILLA_WALKTHROUGH_IMPLEMENTACION.md): Plantilla oficial de entrega post-implementación (.md y .docx).
- [equipo-2-doc/00_SISTEMA/03_PLANTILLAS_Y_CHECKLISTS/PLANTILLA_REPORTE_QA_MODULO.md](./equipo-2-doc/00_SISTEMA/03_PLANTILLAS_Y_CHECKLISTS/PLANTILLA_REPORTE_QA_MODULO.md): Plantilla estándar de informe de pruebas de calidad QA (.md y .docx).
- [equipo-2-doc/01_TRANSVERSALES/M20_SEGURIDAD_Y_AUDITORIA.md](./equipo-2-doc/01_TRANSVERSALES/M20_SEGURIDAD_Y_AUDITORIA.md): Especificación detallada de seguridad, sesiones y datos sensibles.
- [equipo-2-doc/01_TRANSVERSALES/M17_PERMISOS_Y_ROLES.md](./equipo-2-doc/01_TRANSVERSALES/M17_PERMISOS_Y_ROLES.md): Modelo de permisos granulares por empleado.
- [equipo-2-doc/01_TRANSVERSALES/M18_NOTIFICACIONES.md](./equipo-2-doc/01_TRANSVERSALES/M18_NOTIFICACIONES.md): Servicios de correo y notificaciones transaccionales.
- [equipo-2-doc/01_TRANSVERSALES/POLITICAS/](./equipo-2-doc/01_TRANSVERSALES/POLITICAS/): Políticas transversales de unicidad, control de servidor y datos sensibles.
- [equipo-2-doc/02_MODULOS_FUNCIONALES/M04_CUENTAS_AUTH_PERFIL.md](./equipo-2-doc/02_MODULOS_FUNCIONALES/M04_CUENTAS_AUTH_PERFIL.md): Cuentas particulares y empresas, login, registro, perfiles y direcciones.
- `equipo-2-doc/assets/diagrams/`: Diagramas de arquitectura, flujo funcional y secuencia por módulo.