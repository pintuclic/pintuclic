...
const props = defineProps<{
  variant?: 'corporate' | 'action' | 'subaction' | 'conversion' | 'outline' | 'text' | 'primary' | 'google';
  size?: 'sm' | 'md' | 'lg' | 'full';
...
const variantClasses: Record<string, string> = {
  ...
  // Alias histórico del antiguo Boton.vue (mismas clases que "corporate").
  primary: 'bg-corporate hover:bg-corporate/90 text-white focus-visible:ring-corporate',
  google: 'bg-white border border-neutral-light text-neutral-dark hover:bg-neutral-lightest focus-visible:ring-neutral-light shadow-sm',
};
