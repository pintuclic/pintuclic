<template>
  <section aria-label="Simulador de color en ambientes" class="overflow-hidden rounded-xl border border-neutral-light bg-neutral-white shadow-sm">
    ...
    <div class="relative aspect-[5/4] w-full overflow-hidden bg-neutral-lightest">
      <img
        ...
        :class="espacioActual.posicionImagen"
...
const espacios = [
  { id: 'sala', nombre: 'Sala', icono: Sofa, imagen: imgSala, posicionImagen: 'object-bottom' },
  { id: 'cocina', nombre: 'Cocina', icono: UtensilsCrossed, imagen: imgCocina, posicionImagen: 'object-center' },
  { id: 'habitacion', nombre: 'Habitación', icono: BedDouble, imagen: imgHabitacion, posicionImagen: 'object-bottom' },
  { id: 'bano', nombre: 'Baño', icono: Bath, imagen: imgBano, posicionImagen: 'object-center' },
  { id: 'fachada', nombre: 'Fachada', icono: Home, imagen: imgFachada, posicionImagen: 'object-center' },
] as const;
