 ...
 * "Viniltex Advanced Amarillo Profundo"), acotada a los campos reales del
 * backend (CrearProductoDto). El store usa estos datos mientras el backend de
 * M01 no expone los endpoints del formulario.
 *
...
export const OPCIONES_FORMULARIO_DEMO: OpcionesFormularioProducto = {
  ...
  tiposResina: [
    { valor: 'acrilica', etiqueta: 'Acrílica' },
    { valor: 'vinilica', etiqueta: 'Vinílica' },
    { valor: 'alquidica', etiqueta: 'Alquídica' },
    { valor: 'epoxica', etiqueta: 'Epóxica' },
  ],
  marcas: [
...
export function formularioProductoVacio(): FormularioProducto {
  return {
    ...
    descripcion: '',
    subcategoriasIds: [],
    categoriaComplementariaId: null,
    estado: 'borrador',
    marcaId: null,
    lineaId: null,
    tipoResinaId: null,
...
export const FORMULARIO_PRODUCTO_DEMO: FormularioProducto = {
  ...
  subcategoriasIds: ['interiores', 'esmaltes'],
  categoriaComplementariaId: null,
  estado: 'publicado',
  marcaId: 'pintuclic',
  lineaId: 'viniltex-advanced',
  tipoResinaId: 'acrilica',
  ...
  imagenes: [
    { id: 'img-1', url: GALERIA_PRODUCTO_DEMO.frontal, nombre: 'viniltex-advanced-frontal.jpg', orden: 0, esPrincipal: true },
    { id: 'img-2', url: GALERIA_PRODUCTO_DEMO.lateral, nombre: 'viniltex-advanced-lateral.jpg', orden: 1, esPrincipal: false },
    { id: 'img-3', url: GALERIA_PRODUCTO_DEMO.ambiente, nombre: 'ambiente-sala.jpg', orden: 2, esPrincipal: false },
  ],
  patrocinado: true,
};
