...
import type { UsuarioSeguro, ResultadoLogin, LoginPayload } from '../interfaces/registro.interface';
...
export const useAuthStore = defineStore('auth', () => {
  ...
  const login = async (correo: string, contrasena: string): Promise<ResultadoLogin> => {
